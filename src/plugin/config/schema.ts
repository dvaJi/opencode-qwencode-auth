...
const DEFAULT_API_BASE_URL = "https://portal.qwen.ai/v1";
...
export const QwenConfigSchema = z.object({
  client_id: z.string().default(DEFAULT_CLIENT_ID),
  oauth_base_url: z.string().default(DEFAULT_OAUTH_BASE_URL),
  base_url: z.string().default(DEFAULT_API_BASE_URL),
  rotation_strategy: z
